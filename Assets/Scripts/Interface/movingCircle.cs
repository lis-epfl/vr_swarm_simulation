...
public class movingCircle : MonoBehaviour
{
    ...
    [Tooltip("Optional centre override for Circle mode. If unset, the collider/transform centre is used.")]
    ...
    {
        Vector3 c;
        if (obstacle != null) c = obstacle.transform.position;
        else if (footprint != null) c = footprint.bounds.center;
