...
{
    public class CustomTrackBoxGuide : MonoBehaviour
    {
        /// <summary>
        /// Get <see cref="TrackBoxGuide"/> instance. This is assigned
        /// in Awake(), so call earliest in Start().
        /// </summary>
        public static CustomTrackBoxGuide Instance { get; private set; }
        ...
        private CustomEyeTracker _eyeTracker;
        ...
        private void Start()
        {
            _eyeTracker = CustomEyeTracker.Instance;
